...
import useContactsMap from 'app/[locale]/contacts/_components/contacts-map/contacts-map.hook'
import {MapProps} from 'app/[locale]/contacts/_components/contacts-map/contacts-map.types'
