...
const CartOrder: FC<CartOrderProps> = (props) => {
    ...
    return (
        <div className={`cart-order`}>
            ...
            <Button className={'components-order__button'} onClick={onSubmit} loading={createOrder.loading}>
                {transl.makeOrder}
            </Button>
            <Button className={'components-order__button components-order__button--present'} onClick={() => {}}>
                <>
                    {transl.hint}
