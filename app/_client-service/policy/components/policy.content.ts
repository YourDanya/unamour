const policyContent = {
    translations: {
        ...
        eng: {
            ...
            numText26: 'In components-order to perform his duties, the responsible person has the right to:',
            list8: [
                'receive the necessary documents, including components-order and other administrative documents issued by the Owner of the personal data base related to the processing of personal data.',
