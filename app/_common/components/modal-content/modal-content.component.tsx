...
import {ModalContentProps} from 'app/_common/components/modal-content/modal-content.types'
import useModalContent from 'app/_common/components/modal-content/modal-content.hook'
