import {ItemActionsProps} from 'components/admin/items/item-form/item-actions/item-actions.types'
import {useLocale} from 'hooks/other/other.hooks'
import {itemActionsContent} from 'components/admin/items/item-form/item-actions/item-actions.content'
...
import useItemActionsApi from 'components/admin/items/item-form/item-actions/item-actions-api.hook'
import {createItemImagesMap} from 'components/admin/items/item-form/utils/item-form.utils'
import {DeleteItemImagesData} from 'components/admin/items/item-form/item-actions/item-actions.types'
