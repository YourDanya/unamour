...
import {ItemButtonsActions} from 'components/admin/item-form/item-buttons/item-buttons.types'
...
const useItemButtons = (props: ItemButtonsProps) => {
    const {itemValue, _id, imageValues, updateTime, initImageValues} = props
