...
//     const {color, sizes, itemValue, price, variantIndex, errorCount, _id, imageValues} = props
...
//             const isColorError = itemValue.current.common.variants.reduce((isColorError, variant, index) => {
...
//             // console.log('before item err ref', errorCount.current)
//             errorCount.current += afterCount - beforeCount
//             // if (variantIndex === 2) {
//             //     console.log('after count', afterCount)
//             //     console.log('before count', beforeCount)
//             //     console.log('item err ref', errorCount.current)
//             // }
...
//                 field,
//                 _id,
//                 value: {error: {client: errorCount.current, server: null}}
//             }))
//         }
//         const copy: FetchedItem = JSON.parse(JSON.stringify(itemValue.current))
//         copy.common.variants[variantIndex] = {...copy.common.variants[variantIndex], ...inputs.values, sizes}
//         itemValue.current = copy
//     }, [inputs.values, sizeValues])
//
//     useEffect(() => {
//         return () => {
//             const beforeCount = errorCount.current
//             errorCount.current -= variantErrRef.current
//             const afterCount = errorCount.current
...
//         console.log('id', id)
//         console.log('imageValues.current', imageValues.current)
