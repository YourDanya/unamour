const privacyContent = {
    translations: {
        ...
        eng: {
            ...
            numText2: 'An order is considered to be properly executed if the customer has filled in all the fields of the update-input-user-form that allow to identify the customer and contact him:',
            list1: [
                'Full name / name.',
                'Contact phone.',
                'Address.',
            ...
            numText5: 'Employees of the UNAMOR online store update-input-user-form orders. Orders with the status "PROCESSED", formed and confirmed by 15-00, are sent on the same day. In that case, if you made an order on a Sunday or public holiday, its sending is postponed to the first working day following the day of ordering. City of sender - Kyiv. ',
            ...
            list6: [
                'Fill in the return update-input-user-form (sent by the manager at the customer\'s request to the messenger or email).',
                'Send the goods and the completed update-input-user-form to the address indicated in it.',
