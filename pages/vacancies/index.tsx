        ...
        <div className={'vacancies'}>
            ...
            <div className="vacancies__content">
                ...
                <div className="vacancies__category">
                    ...
                    <ul className="vacancies__category-elements">
                        ...
                        <li className="vacancies__category-element">
                            Предполагаемая оплата труда обсуждается с успешным кандидатом по результатам собеседования и
            ...
            <div className="vacancies__content">
                ...
                <div className="vacancies__category">
                    ...
                    <ul className="vacancies__category-elements">
                        <li className="vacancies__category-element">
                            Опыт работы в сфере от 2-х лет;
                        </li>
                        <li className="vacancies__category-element">
            ...
            <div className="vacancies__content">
                ...
                <div className="vacancies__resume">
                    Резюме отправлять на почту creativeteam@gmail.com, указав тему письма "Отклик на вакансию ретушер".
                </div>
            </div>
        </div>
    )
